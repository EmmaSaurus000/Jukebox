                    ...
                    <div class="form-group">
                        ...
                        @foreach($tracks as $track)
                            <label>
                                ...
                                <input type="checkbox" name='old_tracks[]'  checked="checked" value="{{ old('$track->id') ?? $track->id }}">  {{ $track->name }} by {{ $track->artist }} </label><br>
                        @endforeach
                        @foreach($other_tracks as $track)
                            <label>
                                <!-- changed from name="track_id" -->
                                <input type="checkbox" name='new_tracks[]'  value="{{ old('$track->id') ?? $track->id }}">  {{ $track->name }} by {{ $track->artist }} </label><br>
                        @endforeach
